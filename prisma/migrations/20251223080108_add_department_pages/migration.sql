...
INSERT INTO "new_DepartmentSettings" ("allowRecruitment", "announcements", "autoApprove", "createdAt", "department", "description", "discordRole", "enabled", "events", "homepageContent", "id", "maxUnits", "members", "minPlaytime", "motto", "news", "quickStats", "ranks", "requireCertification", "theme", "updatedAt") SELECT "allowRecruitment", "announcements", "autoApprove", "createdAt", "department", "description", "discordRole", "enabled", "events", "homepageContent", "id", "maxUnits", "members", "minPlaytime", "motto", "news", "quickStats", "ranks", "requireCertification", "theme", "updatedAt" FROM "DepartmentSettings";
