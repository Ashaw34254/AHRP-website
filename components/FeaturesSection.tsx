...
const features = [
  {
    ...
    description: "Professional, fair, and approachable staff with extensive roleplay experience providing top-quality support.",
    gradient: "from-yellow-500 to-orange-500",
  },
  {
    icon: Code,
    title: "Custom Scripts & Systems",
    description: "Unique, custom-built features and mechanics designed for fully immersive and realistic gameplay.",
    gradient: "from-purple-500 to-pink-500",
  },
  {
    icon: Ambulance,
    title: "Realistic Emergency Services",
    description: "Fully operational police, fire, and ambulance departments following proper protocols and training.",
    gradient: "from-red-500 to-pink-500",
  },
  {
    icon: Globe,
    title: "AU/NZ-Friendly Community",
    description: "Optimised for Australian and New Zealand time zones, with an active, friendly community around the clock.",
    gradient: "from-blue-500 to-indigo-500",
  },
  {
    icon: Cpu,
    title: "Professional CAD System",
    description: "Advanced Computer-Aided Dispatch system providing reliable coordination for all emergency services.",
    gradient: "from-indigo-500 to-purple-500",
  },
  {
    icon: Radio,
    title: "Authentic Communications",
    description: "Realistic voice and radio systems simulating true emergency service communications.",
    gradient: "from-cyan-500 to-blue-500",
  },
  {
    icon: Car,
    title: "Extensive Vehicle Fleet",
    description: "Diverse and realistic vehicles for police, fire, EMS, and civilian roles to enhance roleplay immersion.",
